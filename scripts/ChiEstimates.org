...
#+BEGIN_SRC ipython :session :tangle yes :exports results :eval never-export :file images/ra12-526-temp-spectra.png
...
ra12.PlotSpectrum('T', filter_len=1800, nsmooth=18,
                  SubsetLength=120*86400, ticks=ticks, norm=False)
plt.grid(True)
#+END_SRC

#+RESULTS:
[[file:images/ra12-526-temp-spectra.png]]

#+BEGIN_SRC ipython :session :tangle yes :exports results :eval never-export :file images/ra12-spectra.png

ticks = np.array([1/2, 1, 2, 5, 10, 20, 30])*86400

ra12.PlotAllSpectra(filter_len=3600*1.8, nsmooth=3,
                    SubsetLength=13*86400, ticks=ticks)

# ra12.χpod[526].PlotSpectrum('chi', filter_len=3600*2, nsmooth=3,
#                            SubsetLength=13*86400, ticks=ticks)
#+END_SRC
