...
#+BEGIN_SRC ipython :session :tangle yes :eval never-export :exports results file :file images/rama13-density-diff.png
  ...
  hax = plt.subplot(211)
  plt.plot(ra107['date'],
           ra107['dens-pre']['20'] - ra107['dens-pre']['10'], linewidth=1)
  plt.axhline(0, color='k')
  plt.ylabel('Δρ 20m-10m')
  hax.xaxis.set_major_formatter(monthsFmt)

  plt.subplot(212)
  plt.plot_date(ra107['date'], ra107['dens-pre']['40'] - ra107['dens-pre']['20'], '-', linewidth=1)
  plt.axhline(0, color='k')
...
#+BEGIN_SRC ipython :session :tangle yes :exports results :eval never-export :file images/rama13-dens-inversion-zoom.png
  ...
  plt.plot(ra107['date'][0:tend],
           ra107['dens-pre']['20'][0:tend] - ra107['dens-pre']['10'][0:tend], linewidth=1)
  plt.axhline(0, color='k')
  plt.ylabel('Δρ 20m-10m')
  hax.xaxis.set_major_formatter(monthsFmt)
