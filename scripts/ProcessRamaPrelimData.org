...
#+BEGIN_SRC ipython :session :tangle yes :exports both
  import numpy as np
...
#+BEGIN_SRC ipython :session :tangle yes :exports both
  ...
  ra107['sal']  = dict([])
  ra107['temp-pre'] = dict([]) # pre-calib applied
  ra107['temp-post'] = dict([]) # post-calib applied
  ra107['temp-proc'] = dict([]) # processed data
  ra107['temp'] = dict([])
...
#+BEGIN_SRC ipython :session :tangle yes :exports both :file images/rama13-sal-pre-post-cal.png
...
#+BEGIN_SRC ipython :session :tangle yes :exports both :file images/rama13-interp-pre-post-sal.png
...
#+BEGIN_SRC ipython :session :tangle yes :exports both :file images/rama13-interp-salinity.png
  plt.figure()
...
#+RESULTS:
*** Compare fully-processed and "preliminary" data
#+BEGIN_SRC ipython :session :tangle yes :exports both :file ra107-pre-proc-temp.png
...
#+BEGIN_SRC ipython :session :tangle yes :exports both :file images/rama14-pre-cal-salinity.png
    plt.figure()
...
#+BEGIN_SRC ipython :session :tangle yes :exports both :file images/ra07-ra122-switch-period.png
  for index, depth in enumerate(ra107['sal'].keys()):
      if index == 0:
          continue
...
#+BEGIN_SRC ipython :session :tangle yes :exports both :file images/rama13-rama14-full-salinity.png
...
#+BEGIN_SRC ipython :session :tangle yes :exports both :file images/rama13-rama14-sal-histograms.png
